...
The styling of the pages is already complete. That said, the `design-files` folder contains both a Figma file and a .jpg of a design if you want to try to build it from scratch. You do not need to use this design at all, either; it depends on how you wish to approach the challenge.
